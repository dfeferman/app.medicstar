...
<tns:CreateSalesOrder xmlns:tns="${NS.ORDER_CREATE.TNS}">
  <tns:inboundCreateInbOrder xmlns:x53="${NS.ORDER_CREATE.NAV}">
    ...
    <x53:Header_Sell_To_Customer>
      <x53:Contact_No>${escapeXml(order.contactNumber)}</x53:Contact_No>
  ...
  console.log("=== CREATE ORDER WITH CONTACT REQUEST ===");
  console.log("Endpoint:", endpoint);
  console.log("Action:", NS.ORDER_CREATE.ACTION);
  console.log("Contact Number:", order.contactNumber);
  ...
  console.log("=== CREATE ORDER WITH CONTACT RESPONSE ===");
