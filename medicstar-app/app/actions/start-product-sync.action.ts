...
//   console.log(`[toggleAutoSync] Setting auto sync to ${enabled} for shop ${shopId} (UPDATE_VARIANTS)`);
...
//     success: true,
//     message: `Product sync ${enabled ? 'enabled' : 'disabled'} successfully`
//   });
// };
...
//   console.log(`[stopPendingTasks] Stopping pending product sync tasks for shop ${shopId}`);
...
//   console.log(`[stopPendingTasks] Found ${pendingJobs.length} pending product sync jobs to stop`);
...
//       logMessage: "Product sync job stopped by user request",
//       updatedAt: new Date()
//     }
//   });
...
//     data: {
//       status: $Enums.Status.FAILED,
//       logMessage: "Product sync process stopped by user request",
//       updatedAt: new Date()
//     }
//   });
...
//   return Response.json({
//     success: true,
//     message: `Stopped ${result.count} pending product sync tasks`
//   });
// };
