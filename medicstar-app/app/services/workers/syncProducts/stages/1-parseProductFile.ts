...
import { getLatestXlsxFile, buildLowerKeyMap, pickFirst, toStringOrEmpty, toNullableString, toPriceStringOrZero, toIntegerOrZero, toIntegerOrNull, deriveBaseTitle, arePricesEqual } from "../../../../utils/xlsx";
...
export const parseProductFile = async (task: any) => {
  await parseLatestDownloadedFile();
  ...
  console.log(`[parseProductFile] ✅ Parse completed. Updated task to CREATE_BULK_TASK.`);
};
